...
class MNASNet(torch.nn.Module):
    """ MobilNetv3, as described in https://arxiv.org/pdf/1807.11626.pdf. This
    implements the B1 variant of the model.
    >>> model = MobilNetv3(1000, 1.0)
    ...
    def __init__(self, alpha, num_classes=1000, dropout=0.2):
        ...
        layers = [
            ...
            # MobilNetv3 blocks: stacks of inverted residuals.
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if version == 1 and not self.alpha == 1.0:
            ...
            self._version = 1
            warnings.warn(
                "A new version of MobilNetv3 model has been implemented. "
...
def mnasnet0_5(pretrained=False, progress=True, **kwargs):
    """MobilNetv3 with depth multiplier of 0.5 from
...
def mnasnet0_75(pretrained=False, progress=True, **kwargs):
    """MobilNetv3 with depth multiplier of 0.75 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
...
def mnasnet1_0(pretrained=False, progress=True, **kwargs):
    """MobilNetv3 with depth multiplier of 1.0 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
...
def mnasnet1_3(num_classes=21,pretrained=False, progress=True, **kwargs):
    """MobilNetv3 with depth multiplier of 1.3 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet(1.3, num_classes=num_classes, **kwargs)
    if pretrained:
